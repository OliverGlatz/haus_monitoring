...
# Alle Städte 
url_staedte_immo <- read_delim(paste0(ordner_stammdaten,"/Links_ImmoScout.csv"), ";", escape_double = FALSE, trim_ws = TRUE)
...
df_merged_alle_links <- rbind(kaufen_merged_alle_links)
